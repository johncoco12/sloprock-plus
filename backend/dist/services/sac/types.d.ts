...
export declare const SAC_BEACON_PORT = 54920;
export declare const SAC_CONTROL_PORT = 54921;
export declare const SAC_PITCH_PORT = 54922;
export declare const SAC_CLIENT_PORT = 54930;
export interface SacSession {
    readonly sessionId: string;
    readonly profileId: number;
    readonly profileName: string;
    readonly sacIp: string;
    readonly sacPort: number;
    lastSeen: number;
...
export type SacInboundMsg = ConnectRequest | HeartbeatMsg | MonitoringStartedMsg | MonitoringStoppedMsg | PitchMsg | ChainStateMsg | PluginListMsg;
