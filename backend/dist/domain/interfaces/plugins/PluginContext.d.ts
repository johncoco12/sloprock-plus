...
export type WSHandler = (socket: WebSocket, request: FastifyRequest) => Promise<void> | void;
export interface PluginRouteHandle {
    register(method: "GET" | "POST" | "PUT" | "DELETE" | "PATCH", path: string, handler: RouteHandler, opts?: {
